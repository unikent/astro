...
use Astro\API\Tests\Support\Doubles\Models\Definitions\Double as DefinitionDouble;
...
class BaseDefinitionTest extends TestCase
{
	...
	public function setUp(){
		parent::setUp();
		$this->definition = __DIR__ . '/../../../Support/Fixtures/definitions/double-definition.json';
	}
